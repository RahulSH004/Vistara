...
export async function gethotelwithrooms(filters, hotel_id) {
    try {
        ...
        if (filters.minprice !== undefined)
            conditions.push(gte(rooms.price_per_night, String(filters.minprice)));
        if (filters.maxprice !== undefined)
            conditions.push(lte(rooms.price_per_night, String(filters.maxprice)));
